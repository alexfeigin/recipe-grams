...
- Keep the shared base palette, `color-scheme`, and font stack in `src/styles/design-tokens.css`; landing, recipe, and calculator pages declare only the theme values they genuinely vary, such as their own `--shadow` depth or page-only accent shades.
